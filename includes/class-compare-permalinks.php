...
class Compare_Permalinks {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Compare_Permalinks_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'compare-permalinks';
	 ...
	 *
	 * - Compare_Permalinks_Loader. Orchestrates the hooks of the plugin.
	 * - Compare_Permalinks_i18n. Defines internationalization functionality.
	 * - Compare_Permalinks_Admin. Defines all hooks for the admin area.
	 * - Compare_Permalinks_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Compare_Permalinks_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Compare_Permalinks_Loader    Orchestrates the hooks of the plugin.
	 */
